...
role: Analyst
context: Calilio, telecom cost of goods review
order: 3
featured: true
...
The finding changed the decision, not just the report. The team did not spend effort on a cut that could not pay off, and focused on the options that could actually change the cost.
